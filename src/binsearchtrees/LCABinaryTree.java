...
/*
 * Given a binary tree and two nodes, find LCA(Lowest Common Ancestor) of the given 
 * two nodes in Binary Tree. Read about LCA if you are having doubts about the definition.
